...
public class SillyOdditiesClientConfig {
    public static ForgeConfigSpec.ConfigValue<Boolean>
            ...
            AUTO_RESOURCEPACK_CONFIG, SPAWN_EGGS_RESOURCEPACK, BAT_RESOURCEPACK, HORSE_LEATHER_ARMOR_RESOURCEPACK,
            EMPTY_AIR_OVERLAY;
    ...
    public SillyOdditiesClientConfig(ForgeConfigSpec.Builder builder) {
        ...
        AUTO_RESOURCEPACK_CONFIG = builder.comment("Automatically enables/disables the required configs when enabling/disabling resource packs.").define("autoResourcepackConfig", true);
        ...
        EMPTY_AIR_OVERLAY = builder.comment("Enable empty air overlay.").define("emptyAirOverlay", true);
        builder.pop();
    }
