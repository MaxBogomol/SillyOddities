...
public class SillyOdditiesBlocks {
    ...
    public static final RegistryObject<Block> CACTUS_FLOWER = BLOCKS.register("cactus_flower", () -> new CactusFlowerBlock(BlockBehaviour.Properties.copy(Blocks.PINK_PETALS).mapColor(MapColor.COLOR_PINK).sound(SillyOdditiesSounds.CACTUS_FLOWER)));
