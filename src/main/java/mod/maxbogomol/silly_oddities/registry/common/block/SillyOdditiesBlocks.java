...
import mod.maxbogomol.silly_oddities.common.block.plant.*;
...
public class SillyOdditiesBlocks {
    ...
    public static final RegistryObject<Block> LEAF_LITTER = BLOCKS.register("leaf_litter", () -> new LeafLitterBlock(BlockBehaviour.Properties.copy(Blocks.PINK_PETALS).mapColor(MapColor.COLOR_BROWN).sound(SillyOdditiesSounds.LEAF_LITTER)));
    public static final RegistryObject<Block> WILDFLOWERS = BLOCKS.register("wildflowers", () -> new PinkPetalsBlock(BlockBehaviour.Properties.copy(Blocks.PINK_PETALS).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final RegistryObject<Block> BUSH = BLOCKS.register("bush", () -> new GrassBushBlock(BlockBehaviour.Properties.copy(Blocks.GRASS).mapColor(MapColor.TERRACOTTA_GREEN).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<Block> FIREFLY_BUSH = BLOCKS.register("firefly_bush", () -> new FireflyBushBlock(BlockBehaviour.Properties.copy(Blocks.GRASS).mapColor(MapColor.TERRACOTTA_GREEN).offsetType(BlockBehaviour.OffsetType.XZ).sound(SillyOdditiesSounds.FIREFLY_BUSH)));
    public static final RegistryObject<Block> CACTUS_FLOWER = BLOCKS.register("cactus_flower", () -> new CactusFlowerGrassBlock(BlockBehaviour.Properties.copy(Blocks.PINK_PETALS).mapColor(MapColor.COLOR_PINK).offsetType(BlockBehaviour.OffsetType.XZ).sound(SillyOdditiesSounds.CACTUS_FLOWER)));
    ...
    public static final RegistryObject<Block> SHORT_DRY_GRASS = BLOCKS.register("short_dry_grass", () -> new ShortDryGrassBlock(BlockBehaviour.Properties.copy(Blocks.GRASS).mapColor(MapColor.TERRACOTTA_YELLOW).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> TALL_DRY_GRASS = BLOCKS.register("tall_dry_grass", () -> new TallDryGrassBlock(BlockBehaviour.Properties.copy(Blocks.GRASS).mapColor(MapColor.TERRACOTTA_YELLOW).offsetType(BlockBehaviour.OffsetType.XZ)));
