...
public class SillyOdditiesCrossBaulkBlock extends CrossBaulkBlock {

    public SillyOdditiesCrossBaulkBlock(Properties properties) {
        super(properties);
    }

    @Override
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return SillyOdditiesWizardsReborn.BlockEntitiesLoadedOnly.CROSS_BAULK.get().create(pos, state);
    }
}
